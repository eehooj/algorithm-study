...
public class WeeklyFour {
    public String solution(String[] table, String[] languages, int[] preference) {
        ...
        for (int i = 0; i < languages.length; i++) {
            lp.put(languages[i], preference[i]);
        }
        ...
        for (int i =0; i < 5; i++) {
            ...
            for (int j = 1; j < job.length; j++) {
                if (lp.containsKey(job[j])) {
                    score +=  lp.get(job[j]) * (6 - j);
                }
            }
...
/*
테스트 1 〉	통과 (0.26ms, 60.5MB)
테스트 2 〉	통과 (0.28ms, 58.7MB)
테스트 3 〉	통과 (0.35ms, 68.8MB)
테스트 4 〉	통과 (0.31ms, 58.8MB)
테스트 5 〉	통과 (0.48ms, 69.4MB)
테스트 6 〉	통과 (0.32ms, 57.7MB)
테스트 7 〉	통과 (0.32ms, 69.7MB)
테스트 8 〉	통과 (0.31ms, 70.4MB)
테스트 9 〉	통과 (0.32ms, 71.8MB)
테스트 10 〉	통과 (0.28ms, 67.9MB)
*/