...
/* 진법 변환 공식
answer.insert(0, count % 3(변환하고자 하는 진법));
count /= 3;

여기서는 진법이 3진법이고, 숫자가 1, 2, 4로 정해져 있음
그래서 1, 2, 4 배열을 만들어서 사용!
그러면 왜 String[] number = {"1", "2", "4"}; 가 아닌 String[] number = {"4", "1", "2"};이냐면
1 % 3 = 1 (1)
2 % 3 = 2 (2)
3 % 3 = 0 (4)
몫 순서대로 하면 {"4", "1", "2"}가 됨

여기서는 0이 되면 그 다름 수가 바로 자릿수가 바뀌게 됨
때문에 count에 -1을 하여 계산을 함
count = (count - 1) / 3;
*/
